...
class Model(object):
    ...
    def calc_acc_loss(self, embeddings, X, labelLen):
        ...
        mlmCost = model_utils.soft_cross_entropy_loss(logits,tf.reshape(self.label_target, [-1]),self.transformer_conf['label_smoothing'], self.transformer_conf['vocab_size'])
